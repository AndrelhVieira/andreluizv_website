...
export const SearchProvider = ({ children }: SearchProviderProps): ReactElement => {
  ...
  const authorSearchItems = authors.map((author) => {
    ...
    return {
      ...
      keywords: '',
      shortcut: [],
      section: locale === fallbackLng ? 'Authors' : locale === secondLng ? 'Autores' : 'Autores',
  ...
  const authorsActions = [
    ...
    ...(showAuthorsSearch
      ...
      : [
          {
            id: 'about',
            name: locale === fallbackLng ? 'About' : locale === secondLng ? 'Sobre' : 'Acerca de',
            keywords: '',
            shortcut: ['a'],
            section:
              locale === fallbackLng ? 'Navigate' : locale === secondLng ? 'Navegar' : 'Navegar',
    ...
    <KBarSearchProvider
      kbarConfig={{
        ...
        defaultActions: [
          {
            id: 'home',
            name: locale === fallbackLng ? 'Home' : locale === secondLng ? 'Início' : 'Inicio',
            keywords: '',
            shortcut: ['h'],
          ...
          },
          {
            id: 'projects',
            name:
              locale === fallbackLng ? 'Projects' : locale === secondLng ? 'Projetos' : 'Proyectos',
            keywords: '',
            shortcut: ['p'],
            section: navigationSection,
