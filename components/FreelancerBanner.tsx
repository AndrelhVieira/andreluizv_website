...
export default async function FreelancerBanner({ locale }: { locale: LocaleTypes }) {
  ...
  return (
    <div className="relative isolate mx-auto flex items-center gap-x-6 overflow-hidden rounded-br-lg rounded-bl-lg bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1 md:w-8/12">
      <div
